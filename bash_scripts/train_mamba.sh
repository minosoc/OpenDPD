#!/usr/bin/env bash
# rev7: Mamba DPD FL sweep at paper config.
# Usage: bash bash_scripts/train_mamba.sh <FL> <gpu_id>
...
echo "==== Mamba d=6 d_state=4 FL=${FL} GPU=${devices} (BS=${BS}) ===="
