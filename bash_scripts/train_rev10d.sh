#!/usr/bin/env bash
# rev10d: GMP-stem kernel sweep @ FL=200, LTL, no PE, d_ff=10.
# Usage: bash bash_scripts/train_rev10d.sh <K> <gpu_id>
...
echo "==== rev10d GMP-stem k=${K} FL=${FL} GPU=${devices} ===="
